...
<div class="row" >
    <div class="col-lg-12">
        <div class="title-action" style="margin-left: 3%;">
            ...
            <a href="Templates/layout/journal-cdj?id=<?php echo $journal_info->journal_id; ?>&type=cash-voucher" target="_blank" class="btn btn-default" style="text-transform:none;font-family: tahoma;"><i class="fa fa-file-text-o"></i> Print Check Voucher</a>
